...
export default function Resume() {
    ...
    useEffect(() => {
        ...
        if (resumePage && isMobile === false) {
            resumePage?.current.addEventListener('mousemove', function (event) {
                parallaxed(event, resumeTitle.current);
            });
        }
    }, []);
    useEffect(() => {
    ...
    return (
        <div>
            ...
            <section
                ref={resumePage}
                className={`${styles.resumePage} ${styles.panel}`}
            >
...
function parallaxed(e: any, className: any) {
