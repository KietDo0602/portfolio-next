...
const cards_arr = [
    ...
    { title: 'Docker', type: 'Back-end', level: 'General' },
    { title: 'Kubernetes', type: 'Back-end', level: 'Intermediate' },
